...
public static class DatabaseSeeder
{
    public static void SeedInitialData(this ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PricingTier>().HasData(starterTier, proPricingTier);

        // Seed pricing features
        var starterFeatures = new[]
        {
            new PricingFeature { Id = 1, PricingTierId = 1, Feature = "Unlimited Access to 100+ Modules", IsIncluded = true, DisplayOrder = 1 },
            new PricingFeature { Id = 2, PricingTierId = 1, Feature = "Interactive Practice Waveforms", IsIncluded = true, DisplayOrder = 2 },
            new PricingFeature { Id = 3, PricingTierId = 1, Feature = "4K Cinematic Video Quality", IsIncluded = true, DisplayOrder = 3 }
        };

        var proFeatures = new[]
        {
            new PricingFeature { Id = 4, PricingTierId = 2, Feature = "All Monthly Pass Features", IsIncluded = true, DisplayOrder = 1 },
            new PricingFeature { Id = 5, PricingTierId = 2, Feature = "Access to Live Monthly Q&As", IsIncluded = true, DisplayOrder = 2 },
            new PricingFeature { Id = 6, PricingTierId = 2, Feature = "Exclusive VIP Masterclasses", IsIncluded = true, DisplayOrder = 3 },
            new PricingFeature { Id = 7, PricingTierId = 2, Feature = "Personalized 1-on-1 Feedback", IsIncluded = true, DisplayOrder = 4 }
        };

        modelBuilder.Entity<PricingFeature>().HasData(
            starterFeatures.Concat(proFeatures)
        );
        ...
        modelBuilder.Entity<HeroContent>().HasData(heroContent);
        ...
        modelBuilder.Entity<CourseModule>().HasData(module1, module2);
        ...
        modelBuilder.Entity<Lesson>().HasData(lesson1, lesson2, lesson3, lesson4);
    }
}
